...
module.exports.home = async (req, res) => {
    ...
    try {
        ...
        if (!productDB.length) {
            ...
            for(let i=6;i<=8;++i)
            {
                await Bidding.create({product:productDB[i].id,bidding_time:3,base_bid:productDB[i].price/10,curr_max_bid:parseInt( productDB[i].price/10),start_time:"Sat Nov 13 2021 12:05:00",end_time:"Mon Nov 15 2021 15:00:00",closed:false})
            }
        }
